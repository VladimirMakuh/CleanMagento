...
use Elogic\Certificate\Query\Type\GetListQuery;
 ...
 */
class TypeDataProvider extends DataProvider
{
    /**
     * @var GetListQuery
     */
    ...
    public function getData(): array
    {
        ...
        foreach ($this->loadedData['items'] as $item) {
            $itemsById[(int)$item[TypeInterface::TYPE_ID]] = $item;
        }

        if ($id = $this->request->getParam(TypeInterface::TYPE_ID)) {
