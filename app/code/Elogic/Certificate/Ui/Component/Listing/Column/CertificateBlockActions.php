 ...
 */
class CertificateBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'Certificate';

    /**
     * Url paths.
     */
    private const EDIT_URL_PATH = 'elogic/certificate/edit';
    private const DELETE_URL_PATH = 'elogic/certificate/delete';
    ...
    public function prepareDataSource(array $dataSource): array
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item[CertificateInterface::CERTIFICATE_ID])) {
                    $entityName = static::ENTITY_NAME;
                    $urlData = [CertificateInterface::CERTIFICATE_ID => $item[CertificateInterface::CERTIFICATE_ID]];
