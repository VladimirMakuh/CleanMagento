 ...
 */
class SubjectBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'Subject';

    /**
     * Url paths.
     */
    private const EDIT_URL_PATH = 'elogic/subject/edit';
    private const DELETE_URL_PATH = 'elogic/subject/delete';
    ...
    public function prepareDataSource(array $dataSource): array
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item[SubjectInterface::SUBJECT_ID])) {
                    $entityName = static::ENTITY_NAME;
                    $urlData = [SubjectInterface::SUBJECT_ID => $item[SubjectInterface::SUBJECT_ID]];
